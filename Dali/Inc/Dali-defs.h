...
#ifndef DALI2_LEDBALLASTCONTROL_DALI_DEFS_H
#define DALI2_LEDBALLASTCONTROL_DALI_DEFS_H
...
// D4i standard memory banks (verify with your driver documentation)
#define BANK_GENERAL                               0
#define BANK_DIAGNOSTICS                           1
#define BANK_MAINTENANCE                           2
#define BANK_MANUFACTURER                          3

// D4i diagnostics bank offsets (verify with your driver documentation)
#define OFFSET_DRIVER_TEMP                         7    // Example offset - check your driver docs
...
#endif //DALI2_LEDBALLASTCONTROL_DALI_DEFS_H